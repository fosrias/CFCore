...
<cffunction name="authenticateUser" returntype="boolean">
    <cfargument name="password" required="true" type="string">
    <cfargument name="user" required="true" type="any">
    <cfreturn user.getcryptedPassword() EQ computeHash(ARGUMENTS.password, 
			     ARGUMENTS.user.getpasswordSalt() )>	
</cffunction>

<cffunction name="encryptUser" returntype="any">
    <cfargument name="user" required="true" type="any">
    <cfscript>
        user.setpasswordSalt( genSalt() );      
        user.setcryptedPassword( computeHash(user.getpassword(), 
