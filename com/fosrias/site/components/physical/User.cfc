          ...
          table="users"
{
    ...
    property name="cryptedPassword" column="crypted_password" type="string" ormtype="string" remotingfetch="false"; 
	property name="passwordSalt" column="password_salt" type="string" ormtype="string" remotingfetch="false"; 
	...
	property name="roles" fieldtype="many-to-many" CFC="UserRole"  linktable="user_roles_users" 
             ...
             cascade="all" orderby="authorizable_id" type="array" remotingfetch="true";
